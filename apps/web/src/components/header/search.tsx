...
export function Search() {
  return (
    <div className="rounded-5xl relative flex w-full max-w-64 items-center gap-4 bg-blue-200 px-6 py-4 focus-within:outline focus-within:outline-2 focus-within:outline-offset-2 focus-within:outline-blue-300">
